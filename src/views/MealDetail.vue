<template>
  <div class="container border rounded">
    <div class="row justify-content-center">
      ...
      <div v-else class="col-sm-11 p-3">
        <div class="row">
          <div class="text-start">
            <h1 class="text-start p-3">{{ meal.strMeal }}</h1>
            ...
            <div class="row mt-3">
              ...
              <div class="col text-left">
                <div>
                  ...
                  <p v-for="(paragrap, index) in paragraph" :key="index">
                    {{ paragrap }}.
                  </p>
                </div>
                <div>
                  ...
                  <div
                    class="text-left"
                    v-for="(ing, index) in filteredArr"
                    :key="index"
                  >
...
export default {
  ...
  created() {
    ...
    axios
      .get(`https://www.themealdb.com/api/json/v2/1/lookup.php?i=${mealId}`)
      .then((resp) => {
